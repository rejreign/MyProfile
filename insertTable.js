...
pool.query(
    `INSERT INTO TeamSydSquad 
                 (ID, NAME, AGE, DEPARTMENT, ROLE, STATUS, CREATED_DT)
                 VALUES 
                 ('1','Sarah','5','Accounting', 'PM', 'Activated', '01-01-2020'),
                 ('2','Tim','10','Engineering','QA','Pending','01-02-2020'),
                 ('3','Joe','17','Manangement', 'PM', 'Activated', '01-02-2020'),
                 ('4','Tolu','25','Manangement','Dev','Pending','01-02-2020'),
                 ('5','Rob','5','Engineering','QA','Activated','01-03-2020'),
                 ('6','Ade','10','Management','QA','Pending','01-04-2020'),
                 ('7','Tom','17','Security','QA','Activated','01-05-2020'),
                 ('8','Jide','26','Accounting','Dev','Activated','01-06-2020')                
                 `,
    (err, res) => {
      if(err) {
